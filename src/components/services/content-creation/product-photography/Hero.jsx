...
export default function Hero({ service }) {
  ...
  const subtitle = service?.shortDesc || service?.metaDescription || "Product Photography built for how online shoppers actually inspect a photo, zoomed in, compared across angles, checked for what the copy left out."
  const isPillar = service?.pageType === 'Pillar Service'
  const pillarParent = service?.pillarParent
  const quote = service?.quote || "Product Photography example showing studio and lifestyle shot styles"
