...
export default function Hero({ service }) {
  ...
  const subtitle = service?.shortDesc || service?.metaDescription || "YouTube Video Production, filming and editing built for long-form retention, not just publishing something and hoping viewers stay."
  const isPillar = service?.pageType === 'Pillar Service'
  const pillarParent = service?.pillarParent
  const quote = service?.quote || "YouTube Video Production example showing filming setup and editing workflow"
