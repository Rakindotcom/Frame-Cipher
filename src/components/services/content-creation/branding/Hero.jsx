...
export default function Hero({ service }) {
  ...
  const subtitle = service?.shortDesc || service?.metaDescription || "Branding services building the full visual and voice system color, typography, messaging, and guidelines, everything a logo alone can't cover."
  const isPillar = service?.pageType === 'Pillar Service'
  const pillarParent = service?.pillarParent
  const quote = service?.quote || "Branding example showing a complete visual identity and guideline system"
