...
export default function Hero({ service }) {
  ...
  const subtitle = service?.shortDesc || service?.metaDescription || "Graphic Design for everything outside social and logo work decks, print materials, packaging, and ads, built from one consistent system."
  const isPillar = service?.pageType === 'Pillar Service'
  const pillarParent = service?.pillarParent
  const quote = service?.quote || "Graphic Design example showing consistent design across print and digital materials"
