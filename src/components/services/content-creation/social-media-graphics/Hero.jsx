...
export default function Hero({ service }) {
  ...
  const subtitle = service?.shortDesc || service?.metaDescription || "Social Media Graphics designed for real platform constraints safe zones, carousel sequencing, and crops not just a nice layout in isolation."
  const isPillar = service?.pageType === 'Pillar Service'
  const pillarParent = service?.pillarParent
  const quote = service?.quote || "Social Media Graphics example showing feed, Story, and carousel design"
