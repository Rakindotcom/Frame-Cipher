...
const documentation = [
  ...
  'Conversion or revenue impact where measurable',
]
  ...
  return (
    <section className="border-t-2 border-frame-border bg-frame-bg px-4 py-20 md:px-8 md:py-28">
      <div className="mx-auto max-w-[95vw]">
        <SectionIntro eyebrow="Verified ecommerce SEO work" title="Ecommerce SEO Results & Case Studies">
          Real project evidence is more useful than generic SEO promises.
        </SectionIntro>

        <p className="text-base font-medium leading-relaxed text-frame-muted-fg md:text-lg">
          Framecipher will showcase verified ecommerce SEO case studies here as they become
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2 lg:items-start">
          ...
          <div className="space-y-5">
            ...
            <PosterButton href="/case-studies">See Our Ecommerce SEO Results</PosterButton>
          </div>
        </div>
      </div>
    </section>
