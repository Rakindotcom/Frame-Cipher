...
const commitments = [
  ...
  'Structured bid and budget optimization',
  'Listing health monitoring',
  'Transparent reporting',
  'Clear communication',
  'Recommendations based on campaign and marketplace data',
]
    ...
    <section className="border-t-2 border-frame-border bg-frame-muted/30 px-4 py-20 md:px-8 md:py-28">
      <div className="max-w-7xl mx-auto">
        <SectionIntro eyebrow="Clear commitment" title="What We Commit To">
          We do not guarantee a specific ACOS, TACOS, sales volume, organic ranking position, or
          revenue outcome.
        </SectionIntro>
