...
const packages = [
  {
    ...
    fee: '\u09F320,000',
    feeNote: 'per month',
    bestFor: 'Businesses starting with structured Microsoft Search campaigns',
    included: [
      'Campaign setup and management',
      'UET and conversion tracking setup',
      'Keyword strategy',
      'Search-term review',
  ...
  {
    name: 'Full Account',
    tag: 'Search + Shopping + Audience',
    fee: '\u09F330,000',
    feeNote: 'per month',
    bestFor: 'Businesses needing Search, Shopping, audience, and LinkedIn Profile Targeting',
    included: [
      ...
      'Network and placement review',
    ],
    cta: 'Request This Plan',
    popular: true,
  },
  {
    name: 'Google Ads Migration',
    tag: 'Import Package',
    fee: '\u09F315,000',
    feeNote: 'one-time + management fee',
    bestFor: 'Businesses moving an established Google Ads account to Microsoft Advertising',
    included: [
      'Google Ads campaign import',
      'Campaign and ad review',
      'Keyword cleanup',
      'Match-type review',
      'Bid-strategy and budget adjustment',
      'Conversion-goal verification',
      'Post-import audit and relaunch',
    ],
    cta: 'Request This Plan',
  },
]
    ...
    <section id="pricing" className="scroll-mt-20 border-t-2 border-frame-border bg-frame-bg px-4 py-20 md:px-8 md:py-28">
      <div className="mx-auto max-w-[95vw]">
        <SectionIntro
          ...
          title="Microsoft Ads Management Pricing"
        >
          Our Microsoft Ads management pricing depends on campaign scope, account complexity,
          Shopping requirements, audience management, migration needs, and reporting requirements.
        </SectionIntro>
        ...
        <div className="mt-8 flex flex-col gap-8 border-2 border-frame-accent bg-frame-accent/5 p-7 md:p-9 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl space-y-3 text-sm md:text-base font-medium leading-relaxed">
            ...
            <p className="text-frame-muted-fg">
              Additional creative production, third-party services, or other implementation work can
              be scoped separately when required. Pricing is quoted in BDT and final pricing is
              confirmed in a written proposal.
            </p>
          </div>
          <div className="shrink-0">
            <PosterButton href="/contact">Get a Custom Microsoft Ads Quote &rarr;</PosterButton>
          </div>
        </div>
      </div>
    </section>
