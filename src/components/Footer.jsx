        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-md">
              Crafting cinematic stories that elevate brands and captivate audiences. 
              Where creativity meets strategy, and vision becomes reality.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-gray-300">Brand Storytelling</span>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-300 mb-2">
                hello@framecipher.com | +1 (555) 123-4567
              </p>
              <p className="text-gray-400 text-sm">
                © 2024 Frame Cipher. All rights reserved.
              </p>
            </div>
          </div>
        </div>
