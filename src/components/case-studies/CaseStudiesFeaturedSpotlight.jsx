...
function StoryPanel({ label, title, children }) {
  return (
    <article className="border-2 border-frame-border bg-frame-bg p-7 md:p-8">
      ...
      <h4 className="mt-5 font-heading text-3xl font-bold uppercase leading-none tracking-tighter text-frame-fg md:text-4xl">
        {title}
      </h4>
...
export default function CaseStudiesFeaturedSpotlight() {
  const featuredStudy = caseStudyPlaceholders[0]

  return (
    <section
      id="featured-spotlight"
      aria-label="Flagship personal brand case study"
      className="scroll-mt-[100px] border-t-2 border-frame-border px-4 py-20 md:px-8 md:py-28"
    >
      <div className="mx-auto max-w-[95vw]">
        {/* Spotlight Banner Header */}
        <div className="border-b-2 border-frame-border pb-10">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <span className="border-2 border-frame-accent bg-frame-accent/15 px-3.5 py-1.5 text-xs font-black uppercase tracking-[0.24em] text-frame-accent">
              Flagship Personal Brand Case Study
            </span>
            <span className="text-xs font-mono font-bold uppercase tracking-wider text-frame-muted-fg">
              Platform Growth · 7.2M+ Views
            </span>
          </div>

          <div className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <div>
              <h3 className="font-heading text-[clamp(2.35rem,6vw,5.5rem)] font-bold uppercase leading-[0.84] tracking-tighter text-frame-fg">
                {featuredStudy.title}
              </h3>
        ...
        <div className="mt-12 grid gap-px border-2 border-frame-border bg-frame-border sm:grid-cols-2 lg:grid-cols-4">
          {featuredStudy.results.map((result) => (
            <article key={result.label} className="bg-frame-bg p-6 md:p-8">
              ...
              <h4 className="mt-5 font-heading text-2xl font-bold uppercase leading-none tracking-tighter text-frame-fg">
                {result.label}
              </h4>
        ...
        {/* The Challenge & 3 Strategic Pillars */}
        <div className="mt-20">
        ...
        {/* The 4 Production Engine Stages */}
        <div className="mt-20 border-t-2 border-frame-border pt-20">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {featuredStudy.processStages?.map((stage) => (
              ...
              >
                ...
                <h4 className="mt-4 font-heading text-xl font-bold uppercase leading-tight tracking-tighter text-frame-fg transition-colors duration-300 group-hover:text-frame-accent-fg md:text-2xl">
                  {stage.title}
                </h4>
        ...
        <div className="mt-20 border-t-2 border-frame-border pt-20">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <article className="border-2 border-frame-border bg-frame-accent p-7 text-frame-accent-fg md:p-10">
              ...
              <h4 className="mt-5 font-heading text-[clamp(2.3rem,7vw,5.5rem)] font-bold uppercase leading-[0.82] tracking-tighter">
          ...
          {/* First-Party Platform Proof Screenshots */}
          <div className="mt-14">
            <div className="flex flex-col gap-3 border-b-2 border-frame-border pb-6 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h4 className="mt-2 font-heading text-3xl font-bold uppercase tracking-tighter text-frame-fg md:text-5xl">
              ...
              {featuredStudy.proofImages?.map((proof) => (
                ...
                >
                  ...
                  <figcaption className="border-t-2 border-frame-border p-5">
                    <h5 className="font-heading text-lg font-bold uppercase tracking-tight text-frame-fg">
                      {proof.title}
                    </h5>
